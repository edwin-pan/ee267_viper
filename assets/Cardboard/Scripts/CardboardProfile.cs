...
/// Parameters for an iPhone 6p device.
public static readonly Screen EE267ViewMaster = new Screen
{
    width = 0.1325f,
    height = 0.0745f,
    border = 0.004f
  ...
  public static readonly Device GoggleTechC1Glass = new Device {
    ...
    /// Parameters for a Cardboard v2.
    public static readonly Device ViewMasterEE267 = new Device
    {
        lenses = {
        separation = 0.064f,
        offset = 0.035f,
        screenDistance = 0.039f,
        alignment = Lenses.AlignCenter,
    },
        maxFOV = {
        outer = 50.0f,
        inner = 50.0f,
  ...
  public static CardboardProfile GetKnownProfile(ScreenSizes screenSize, DeviceTypes deviceType) {
    ...
    switch (screenSize) {
      ...
      case ScreenSizes.iPhone6p:
        screen = iPhone6p;
        break;
      case ScreenSizes.ViewMasterEE267:
        screen = EE267ViewMaster;
        break;
      default:
        screen = Nexus5;
        break;
    ...
    switch (deviceType) {
      ...
      case DeviceTypes.GoggleTechC1Glass:
        ...
        break;
      case DeviceTypes.ViewMasterEE267:
        device = ViewMasterEE267;
        break;
      default:
        device = CardboardJun2014;
        break;
